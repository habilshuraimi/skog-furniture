...
export const salesreport = async(req,res)=>{
    try {
        ...
        res.render("sales", { salesData, totalSalesPrice, totalRegularPrice, totalDiscountPrice })
    } catch (error) {
...
export const filterReoprt = async (req, res) => {
    try {
        ...
        res.render("sales", { salesData, totalDiscountPrice, totalRegularPrice, totalSalesPrice })
    } catch (error) {
        console.log("Error while filtering the report", error.message)
    }
}

export const filterCustomDateOrder = async (req, res) => {
    try {
        ...
        res.render("sales", { salesData, totalRegularPrice, totalDiscountPrice, totalSalesPrice })
    } catch (error) {
